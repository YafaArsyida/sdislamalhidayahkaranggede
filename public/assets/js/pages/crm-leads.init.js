...
var isValue = (isCount = new DOMParser().parseFromString(
    ...
    count = 11,
    tagInputField = new Choices("#taginput-choices", { removeItemButton: !0 }),
    tagInputFieldValue = tagInputField.getValue(!0),
    tagHtmlValue = "",
    forms =
        (Array.from(tagInputFieldValue).forEach((e, t) => {
            tagHtmlValue +=
                '<span class="badge bg-primary-subtle text-primary me-1">' +
                e +
                "</span>";
        }),
        document.querySelectorAll(".tablelist-form"));
                ...
                e.addEventListener("click", function (e) {
                    ...
                    Array.from(e).forEach(function (e) {
                        var t = (isid = new DOMParser().parseFromString(
                            ...
                            a = new DOMParser()
                                .parseFromString(e._values.tags, "text/html")
                                .body.querySelectorAll("span.badge");
                        t == itemId &&
                            ((editlist = !0),
                            (idField.value = t),
                            (leadImg.src = e._values.image_src),
                            (leadNameField.value = e._values.name),
                            ...
                            a &&
                                Array.from(a).forEach((e) => {
                                    tagInputField.setChoiceByValue(e.innerHTML);
                                }),
                ...
                ? (e.preventDefault(),
                  ...
                  editlist
                      ? "" !== leadNameField.value &&
                        ...
                        "" !== locationField.value &&
                        editlist &&
                        ((t = leadsList.get({ id: idField.value })),
                        Array.from(t).forEach(function (e) {
                            var t = (isid = new DOMParser().parseFromString(
                                    e._values.id,
                                    "text/html"
                                )).body.firstElementChild.innerHTML,
                                a = tagInputField.getValue(!0),
                                l = "";
