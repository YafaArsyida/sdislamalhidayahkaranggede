<div>
    ...
    <div wire:ignore.self class="modal fade" id="ModalAddTahunAjar" tabindex="-1" aria-labelledby="ModalAddTahunAjarLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-light p-3">
                    <h5 class="modal-title">tahun ajar baru</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                </div>
                <form id="formAddTahunAjar" wire:submit.prevent="save">
