...
<div>
    <div wire:ignore.self class="modal fade" id="ModalAksiTambah" tabindex="-1" aria-labelledby="ModalAksiTambahLabel" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header bg-light p-3">
                    <h5 class="modal-title">Tambah Tagihan Siswa : {{ $namaSiswa }}</h5>
