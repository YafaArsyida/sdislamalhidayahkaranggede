...
<div wire:ignore.self class="modal fade" id="createPesanTabunganSiswa" tabindex="-1" aria-labelledby="createPesanTabunganSiswaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createPesanTabunganSiswaLabel">Setting Pesan Transaksi Tabungan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form wire:submit.prevent="createPesan">
