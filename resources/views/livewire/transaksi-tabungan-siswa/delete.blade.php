...
<div>
    <div class="modal fade zoomIn" id="ModalDeleteTabungan" tabindex="-1" aria-labelledby="deleteRecordLabel" aria-hidden="true" wire:ignore.self>
                ...
                <div class="modal-body p-5 text-center">
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <div class="hstack gap-2 justify-content-center remove">
                            ...
                            <button class="btn btn-danger" wire:click="deleteTabungan">Ya, Hapus!</button>
                        </div>
                    </div>
                </div>
            </div>
