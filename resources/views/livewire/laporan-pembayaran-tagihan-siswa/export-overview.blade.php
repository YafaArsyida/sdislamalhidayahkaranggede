...
<div>
    <div class="modal fade zoomIn" id="ExportOverviewPembayaran" tabindex="-1" aria-labelledby="exportRecordLabel" aria-hidden="true" wire:ignore.self>
                ...
                <div class="modal-body p-5 text-center">
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <p class="text-muted fs-14 mb-4 pt-1">
                            Apakah Anda yakin ingin mengekspor laporan overview pembayaran? Data yang diekspor akan sesuai dengan tabel yang ditampilkan.
                        </p>
