<div wire:ignore.self class="modal fade" id="ModalImportEduCardPegawai" tabindex="-1" aria-labelledby="ModalAddpegawai" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light p-3">
                <h5 class="modal-title">Import EduCard Pegawai {{ $namaJenjang }}</h5>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="text-center">
                            ...
                            <h4 class="fs-semibold">Import EduCard Pegawai</h4>
                                ...
                                <tbody>
                                    @forelse ($oldPegawaiList as $index => $pegawai)
                                        <tr>
                                            ...
                                            <td>{{ $namaJenjang }}</td>
                                            <td>
                                                @if($pegawai->ms_educard)
                                                <span class="fs-14 fw-semibold">    
                                                    {{ $pegawai->ms_educard->kode_kartu }}
                                                </span>
                                                @else
                    ...
                    <div class="col-md-6">
                        ...
                        <p>Unduh format data pegawai {{ $namaJenjang }}
                            <a style="cursor: pointer" class="text-success d-inline-block detail-item-btn ms-3" wire:click="exportEduCard">
                                <i class="ri-file-excel-2-line fs-17 align-middle"></i> Template
                            </a>

                        </p>
                        <p>Isikan pada kolom 'educard'. Ingat! jangan mengubah data ID dan nama.</p>
