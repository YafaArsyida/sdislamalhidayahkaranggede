<div class="card">
    <div class="card-header align-items-center d-flex">
        <h4 class="card-title mb-0">Pesan Transaksi Pembayaran</h4>   
        <div class="ms-auto"> <!-- Menambahkan ms-auto untuk mendorong ke kanan -->
            <div class="dropdown">
                @if ($selectedJenjang)      
                    <button class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#kuitansiTransaksi" aria-controls="kuitansiTransaksi" wire:click="$emit('refreshKuitansi', {{ $selectedJenjang }})"><i class="ri-file-paper-2-line me-1 align-bottom"></i> Kuitansi Pembayaran</button>
                    @if (!$pesans)
                        <button data-bs-target="#createPesanTransaksi" data-bs-toggle="modal" wire:click="$emit('createPesanTransaksi', {{ $selectedJenjang }})" class="btn btn-soft-success shadow-none"><i class="ri-whatsapp-line align-bottom me-1"></i> Setting WhatsApp</button>
                    @else
                    <button data-bs-target="#ModalEdit" data-bs-toggle="modal" wire:click="$emit('loadPesanTransaksi', {{ $ms_pesan_id }})" class="btn btn-soft-success shadow-none"><i class="ri-whatsapp-line align-bottom me-1"></i> Edit WhatsApp</button>
                    @endif
                @endif
            </div>
        </div>
