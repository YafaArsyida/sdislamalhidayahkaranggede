        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-light p-3">
                    ...
                    <a href="{{ url('storage/templates/template_import_siswa.xlsx') }}" 
                ...
                <form wire:submit.prevent="createPenempatan">
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                 <label for="ms_kelas_id" class="form-label">Penempatan Kelas</label>
                                <select id="ms_kelas_id" wire:model="ms_kelas_id" class="form-select">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Buat Penempatan</button>
                    </div>
                </form>
            </div>
        </div>
