...
<div wire:ignore.self class="modal fade" id="createPesanTagihanSiswa" tabindex="-1" aria-labelledby="createPesanTagihanSiswaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createPesanTagihanSiswaLabel">Setting Pesan Tagihan Siswa</h5>
