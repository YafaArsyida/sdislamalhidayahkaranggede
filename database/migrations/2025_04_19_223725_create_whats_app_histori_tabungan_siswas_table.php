...
return new class extends Migration
{
    ...
    {
        Schema::create('ms_whatsapp_histori_tabungan_siswa', function (Blueprint $table) {
            $table->id('ms_whatsapp_histori_tabungan_siswa_id');
    ...
    {
        Schema::dropIfExists('ms_whatsapp_histori_tabungan_siswa');
    }
};
