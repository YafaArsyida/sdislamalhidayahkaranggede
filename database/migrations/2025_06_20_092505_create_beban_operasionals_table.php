...
return new class extends Migration
{
    ...
    {
        Schema::create('ms_beban_operasional', function (Blueprint $table) {
            $table->id('ms_beban_operasional_id');
            $table->unsignedBigInteger('ms_pengguna_id');
            $table->unsignedBigInteger('ms_jenjang_id');
            $table->unsignedBigInteger('ms_tahun_ajar_id');
            $table->enum('jenis_beban_operasional', ['transportasi', 'kesejahteraan pegawai', 'utilitas', 'sewa', 'alat tulis kantor', 'promosi', 'teknologi', 'lain lain']);
    ...
    {
        Schema::dropIfExists('ms_beban_operasional');
    }
};
