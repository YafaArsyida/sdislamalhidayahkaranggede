...
return new class extends Migration
{
    ...
    {
        Schema::create('ms_whatsapp_histori_tagihan', function (Blueprint $table) {
            $table->id('ms_whatsapp_histori_tagihan_id');
    ...
    {
        Schema::dropIfExists('ms_whatsapp_histori_tagihan');
    }
};
