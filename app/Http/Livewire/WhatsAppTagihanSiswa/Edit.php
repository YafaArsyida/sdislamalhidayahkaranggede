...
{
    public $ms_whatsapp_tagihan_siswa_id;
    public $judul;
    ...
    protected $listeners = ['loadPesanTagihanSiswa'];

    public function loadPesanTagihanSiswa($ms_whatsapp_tagihan_siswa_id)
    {
        $pesan = WhatsAppTagihanSiswa::findOrFail($ms_whatsapp_tagihan_siswa_id);

        $this->ms_whatsapp_tagihan_siswa_id = $pesan->ms_whatsapp_tagihan_siswa_id;
    ...
    public function updatePesan()
    {
        ...
        try {
            ...
            $pesan = WhatsAppTagihanSiswa::withTrashed()->findOrFail($this->ms_whatsapp_tagihan_siswa_id);
            ...
            $this->dispatchBrowserEvent('hide-create-modal', ['modalId' => 'ModalEditTagihanSiswa']);
            $this->emit('UpdatePesanTagihanSiswa');
        } catch (\Exception $e) {
            DB::rollBack();
