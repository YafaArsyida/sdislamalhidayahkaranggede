...
class Create extends Component
{
    ...
    protected $listeners = ['createPesanTagihanSiswa'];

    public function createPesanTagihanSiswa($ms_jenjang_id)
    {
    ...
    public function createPesan()
    {
        ...
        try {
            ...
            $this->dispatchBrowserEvent('hide-create-modal', ['modalId' => 'createPesanTagihanSiswa']);
    ...
    public function render()
    {
        ...
        return view('livewire.whats-app-tagihan-siswa.create', compact('surat'));
    }
}
