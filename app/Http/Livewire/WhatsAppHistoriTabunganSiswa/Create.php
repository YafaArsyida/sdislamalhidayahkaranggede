...
class Create extends Component
{
    ...
    protected $listeners = ['createPesanTabunganSiswa'];

    public function createPesanTabunganSiswa($ms_jenjang_id)
    {
    ...
    public function createPesan()
    {
        ...
        try {
            // Buat pesan baru
            WhatsAppHistoriTabunganSiswa::create([
            ...
            $this->dispatchBrowserEvent('hide-create-modal', ['modalId' => 'createPesanTabunganSiswa']);
    ...
    {
        return view('livewire.whats-app-histori-tabungan-siswa.create');
    }
}
