...
{
    public $ms_whatsapp_histori_tabungan_siswa_id;
    public $judul;
    ...
    protected $listeners = ['loadPesanTabunganSiswa'];

    public function loadPesanTabunganSiswa($ms_whatsapp_histori_tabungan_siswa_id)
    {
        $pesan = WhatsAppHistoriTabunganSiswa::findOrFail($ms_whatsapp_histori_tabungan_siswa_id);

        $this->ms_whatsapp_histori_tabungan_siswa_id = $pesan->ms_whatsapp_histori_tabungan_siswa_id;
    ...
    public function updatePesan()
    {
        ...
        try {
            ...
            $pesan = WhatsAppHistoriTabunganSiswa::withTrashed()->findOrFail($this->ms_whatsapp_histori_tabungan_siswa_id);
            ...
            $this->dispatchBrowserEvent('hide-create-modal', ['modalId' => 'loadPesanTabunganSiswa']);
            $this->emit('UpdatePesanTransaksiTabunganSiswa');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    {
        return view('livewire.whats-app-histori-tabungan-siswa.edit');
    }
}
